...
def main(): 
    ...
    if not video.isOpened():  # Check if the web cam is opened correctly
        ...
        while True:   
            ...
            # dic_blue = {'blue_min': blue_min, 'blue_max': blue_max}
            # dic_green = {'green_min': green_min, 'green_max': green_max}
            # dic_red = {'red_min': red_min, 'red_max': red_max}
            ...
            # upper_thresholds=np.array([threshold['global_maximum_red
